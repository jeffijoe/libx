...
export type StoreFactory<TRootStore> = (storeClass: StoreClass<TRootStore>, rootStore: TRootStore) => Store
 ...
 */
export function createRootStore<TRootStore> (obj: IStoreMap<TRootStore>, factory?: StoreFactory<TRootStore>): TRootStore {
  const result: any = {}
  factory = factory || ((storeClass, rootStore) => new storeClass({ rootStore }))
